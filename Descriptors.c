...
const USB_Descriptor_Configuration_t PROGMEM ConfigurationDescriptor =
{
	...
	.Audio_ControlInterface_SPC =
		{
			.Header                   = {.Size = sizeof(USB_Audio_Descriptor_Interface_AC_2_t), .Type = DTYPE_CSInterface},
			.Subtype                  = AUDIO_DSUBTYPE_CSInterface_Header,

			.ACSpecification          = VERSION_BCD(1,0,0),
			.TotalLength              = (sizeof(USB_Audio_Descriptor_Interface_AC_2_t) +
			...
			.InCollection             = 2,
			.InterfaceNumber1         = INTERFACE_ID_AudioOutStream,
			.InterfaceNumber2		= INTERFACE_ID_AudioInStream,
		},
	.Audio_InputTerminal =
		{
			...
			// .TerminalType             = (AUDIO_TERMINAL_IN_MIC | AUDIO_TERMINAL_STREAMING),
			.AssociatedOutputTerminal = 0x2,
	...
	.Audio_OutputTerminal2 =
		{
			...
			.TerminalID               = 0x04,
			.TerminalType             = (AUDIO_TERMINAL_STREAMING),
			// .TerminalType             = (AUDIO_TERMINAL_OUT_SPEAKER | AUDIO_TERMINAL_STREAMING),
	...
	.Audio_Extra_StreamInterface =
		{
			.Header                   = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},

			.InterfaceNumber          = INTERFACE_ID_AudioOutStream,
			.AlternateSetting         = 0,
	...
	.Audio_Out_StreamEndpoint_SPC =
		{
			...
			.Audio_Extra_StreamInterface2 =
				{
					.Header                   = {.Size = sizeof(USB_Descriptor_Interface_t), .Type = DTYPE_Interface},

					.InterfaceNumber          = INTERFACE_ID_AudioInStream,
					.AlternateSetting         = 0,
 ...
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ManufacturerString = USB_STRING_DESCRIPTOR(L"James McDonnell");

/** Product descriptor string. This is a Unicode string containing the product's details in human readable form,
 *  and is read out upon request by the host when the appropriate string ID is requested, listed in the Device
 *  Descriptor.
 */
const USB_Descriptor_String_t PROGMEM ProductString = USB_STRING_DESCRIPTOR(L"HyperJames Audio");
